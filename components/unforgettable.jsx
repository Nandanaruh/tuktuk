export default function Unforgettable() {
  return (
    ...
    >
      <p className="text-lg">Embark on an Unforgettable Adventure</p>
      ...
      <p className="flex text-center justify-center text-lg my-4 mx-40">
        We rent tuktuks to travellers who want the freedom to explore Sri Lanka
        by driving an authentic and reliable rickshaw! Moreover get off the
        beaten track and find the amazing places other tourists miss.
      </p>
    </section>
  );
}
