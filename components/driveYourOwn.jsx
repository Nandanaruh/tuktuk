...
//       </p>
//       <p className="text-lg my-4 mx-50">
...
export default function DriveYourOwn() {
  return (
    <section className="flex flex-col items-center text-center px-4 sm:px-6 md:px-12 lg:px-20 py-8">
      <p
        className="text-sky-700 font-amatic"
        style={{
          fontFamily: "'Amatic SC', cursive",
      ...
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-black my-4">
        Drive Your Own Tuktuk
      </h2>
      ...
      <p className="text-base sm:text-lg my-4 text-gray-800 max-w-3xl">
        We rent tuktuks to travellers who want the freedom to explore Sri Lanka
