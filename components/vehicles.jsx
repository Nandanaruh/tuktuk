  ...
  return (
    <div>
      ...
      <div className="flex flex-row items-center justify-end my-2">
        <Link href="#low-season">
          <Button className="uppercase w-[200px] gap-2 rounded-full hover:bg-sky-800 mx-2 py-1">
            Reserve Your Tuktuk!
          </Button>
        </Link>
      </div>
...
//         <button
//           onClick={goToPrev}
//           className="absolute left-2 top-1/2 z-50 transform -translate-y-1/2 bg-white text-black p-2 shadow-md hover:bg-amber-300 transition-colors duration-300"
//           disabled={isTransitioning}
//         >
//           <ArrowLeft />
//         </button>
//         <button
//           onClick={goToNext}
//           className="absolute right-2 top-1/2 z-50 transform -translate-y-1/2 bg-white text-black p-2 shadow-md hover:bg-amber-300 transition-colors duration-300"
//           disabled={isTransitioning}
//         >
//           <ArrowRight />
//         </button>
...
//                 className="px-2 flex-shrink-0"
//               >
//                 <div className="relative w-full h-48 sm:h-64 md:h-72 lg:h-80 z-50">
//                   <Image
//                     src={vehicle.image}
//                     alt={vehicle.title}
//                     fill
...
//                 <Card className="-mt-36 sm:-mt-44 relative h-[420px] z-10 bg-sky-700 shadow-xl rounded-t-none rounded-b-xl">
//                   <CardContent className="mt-16 sm:mt-20 pt-20 px-4 text-left">
//                     <h3 className="text-xl sm:text-2xl text-white font-bold uppercase">
//                       {vehicle.title}
//                     </h3>
//                     <p className="text-lg font-semibold text-amber-400">
//                       {vehicle.price}
//                     </p>
//                     <p className="text-sm sm:text-md text-white font-semibold text-justify">
//                       {vehicle.description}
//                     </p>
//                   </CardContent>
//                 </Card>
...
//         <Link href="#low-season">
//           <Button className="uppercase w-full sm:w-[200px] gap-2 rounded-full hover:bg-sky-800 mx-2 py-2">
//             Reserve Your Tuktuk!
//           </Button>
//         </Link>
//       </div>
